    ...
    .then(function () {
      return knex('lesson_plans').insert([
        { id: 1,
          ...
          standardsObject: {"MS-ESS2-4":"Develop a model to describe the cycling of water through Earth's systems driven by energy from the sun and the force of gravity.", "MS-ESS2-5":"Develop a model to describe the cycling of fire through Earth's systems driven by energy from the sun and the force of gravity."  },
